# -*- coding: utf-8 -*-
"""SklearnClassifier.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jJjCwH2sF27mJZTueW2Q6Dpp8NnaGO7Y
"""
...
from sklearn.linear_model import LogisticRegression # load the logistic regression model from sklearn
...
classification = LogisticRegression(solver='lbfgs', multi_class='multinomial') # create the logistic regression model with the solver method as 'lbfgs' and the multi-class selection method as multinomial
